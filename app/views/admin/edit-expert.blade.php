...
@section("content")
    ...
    <form class="form-horizontal" method="post" action="/adm/expert/edit-expert">
        ...
        <div class="form-group">
            <input type="hidden" class="form-control" id="id" name="id" value="{{$expert->id}}">
        </div>
        <div class="form-group">
            <label for="name" class="col-sm-2 control-label"><span style="color:red;">*</span>姓名</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="username" name="username" value="{{$expert->username}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <img style="width:160px;height:200px;" alt="" id="thumb" src="{{$expert->portrait}}"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="postion" name="postion" value="{{$expert->post}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <script id="description" name="description" type="text/plain"> {{$expert->introduction}}</script>
